...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Collapse Menu - System Management -->
            <li class="nav-item">
            ...
            <!-- Nav Item - Collapse Menu - User Management -->
            <li class="nav-item">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Employee Manager 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <!-- Javascript and jQuery for Bootstrap 4-->
